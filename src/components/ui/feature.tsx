...
export function FeatureSection({
  ...
  return (
    <Container effect="slide-right" className="w-full">
      <Glass>
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <div>
              <p className="inline-block bg-green-400 px-4 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
                {subtitle}
              </p>
            </div>
          ...
          <div
            className={cn("grid gap-8 row-gap-10 lg:grid-cols-2", childClass)}
          >
