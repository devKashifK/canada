          ...
          <div className="flex-1 flex flex-col gap-2">
            ...
            <div className="flex flex-col justify-start gap-6">
              ...
              <p className="text-sm text-black/60 text-left">
                Provincial nominee programs like the New Brunswick Skilled
                Worker Stream play a crucial role in addressing specific labor
                market needs in individual provinces, contributing to economic
                growth, and providing opportunities for skilled immigrants to
                establish themselves in Canada.
                <Title subtitle="Programs" className="pt-7" />
                <ul className="pl-6 list-disc">
                  <li>Express Entry Labor Market Stream</li>
                  <li>Skilled Workers with Employer Support</li>
                  <li>Post-Graduate Entrepreneurial Stream</li>
                  <li>Entrepreneurial Stream</li>
                  <li>Succession Connect pilot program</li>
                  <li>Atlantic Pilot Immigration Program</li>
                </ul>
              </p>
            </div>
          </div>
