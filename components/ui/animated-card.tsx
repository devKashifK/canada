...
export function CardDemo({ children }) {
  return (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full p-8 bg-gray-100 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 rounded-2xl border-gray-100 group ",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "absolute right-[50%] h-[15rem] md:h-[20rem] rounded-xl z-40",
        className,
        showGradient && ""
      )}
    >
